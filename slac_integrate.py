...
def run(config):
    ...
    slac_folder = path_dataset +config["subfolder_slac"]
    ...
    for i in range(0,n_files):
        ...
        col= config["path_dataset"]+config["path_color"]+'image_'+num+'.png' 
        dep= config["path_dataset"]+config["path_depth"]+'depth_'+num+'.png' 
        # color_raw = o3d.io.read_image(col)
        # depth_raw = o3d.io.read_image(dep)
        # rgbd_image = o3d.geometry.RGBDImage.create_from_color_and_depth(color_raw, depth_raw,convert_rgb_to_intensity=False)
        color_files.append(col)
        depth_files.append(dep)
    ...
    posegraph = o3d.io.read_pose_graph(temp)
    ...
    for i in range(len(posegraph.nodes)):
        ...
        for node in fragment_pose_graph.nodes:
            ...
            # rgbd= o3d.geometry.RGBDImage.create_from_color_and_depth(color_files[k], depth_files[k],convert_rgb_to_intensity=False)
    ...
    #     save_pcd_path = slac_folder+"output_slac_pointcloud.ply"
    ...
    save_mesh_path = "output_slac_mesh.ply"
    o3d.io.write_triangle_mesh(save_mesh_path, mesh_legacy)
    o3d.t.io.write_point_cloud("output_slac_pointcloud.ply", pcd)
