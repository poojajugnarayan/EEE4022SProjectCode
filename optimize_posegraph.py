...
def optimize_posegraph_for_fragment(path_dataset, fragment_id, config):
    ...
    fid=str(fragment_id)
    pose_graph_name=path_dataset+config["template_fragment_posegraph"]+"frag"+str(fragment_id)+".json"
    
    pose_graph_optimized_name = path_dataset+config["template_fragment_posegraph_optimized"]+"frag"+fid+".json"
...
def optimize_posegraph_for_scene(path_dataset, config):
    pose_graph_name=path_dataset+config["template_global_posegraph"]+"pose.json"
    
    pose_graph_optimized_name = path_dataset+config["template_global_posegraph_optimized"]+"pose.json"
...
def optimize_posegraph_for_refined_scene(path_dataset, config):
    pose_graph_name=path_dataset+config["template_refined_posegraph"]+"pose.json"
    
    pose_graph_optimized_name = path_dataset+config["template_refined_posegraph_optimized"]+"pose.json"
