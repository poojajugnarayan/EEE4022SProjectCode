...
def compute_initial_registration(s, t, source_down, target_down, source_fpfh,
    ...
    if t == s + 1:  # odometry case
        ...
        temp=path_dataset+config["template_fragment_posegraph_optimized"]+"frag"+str(s)+".json"
        pose_graph_frag = o3d.io.read_pose_graph(temp)
...
def make_posegraph_for_scene(ply_file_names, config):
    ...
    temp=config["path_dataset"]+config["template_global_posegraph"]+ "pose.json"
