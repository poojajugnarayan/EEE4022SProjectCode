...
if __name__ == "__main__":
    ...
    for j in range(0,15):
        num= str(j)
        if(j<10):
            image_path= input_dir+'00000'+num+'_color.png' 
        elif(j<100):
            image_path= input_dir+'0000'+num+'_color.png' 
        elif(j<1000):
            image_path= input_dir+'000'+num+'_color.png' 
        else:
            image_path= input_dir+'00'+num+'_color.png' 
        ...
        plt.axis('off')
        if(i<10):
            result= '00000'+num+'_segmented.png' 
        elif(i<100):
            result= '0000'+num+'_segmented.png' 
        elif(i<1000):
            result= '000'+num+'_segmented.png' 
        else:
            result= '00'+num+'_segmented.png' 
        ...
        num= str(i)
        if(i<10):
            col= input_dir+'00000'+num+'_segmented.png' 
            dep= input_dir+'00000'+num+'_aligned_depth.png' 
        elif(i<100):
            col= input_dir+'0000'+num+'_segmented.png' 
            dep= input_dir+'0000'+num+'_aligned_depth.png'
        elif(i<1000):
            col= input_dir+'000'+num+'_segmented.png' 
            dep= input_dir+'000'+num+'_aligned_depth.png'  
        else:
            col= input_dir+'00'+num+'_segmented.png' 
